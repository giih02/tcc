...
###########SEXTA feira horarios############################################################################################
	   ...
	   <tr><button id="segunda"> Segunda - feira</button>
        ...
        <td>    <input type='submit'id="ulti" value="14:30" name="14:30">   
	...
	<tr><button id="terca"> Terça - feira</button>
	    ...
	    <td>	<input type='submit'id="ulti2" value="14:30" name="14:30t">   
	...
	<tr><button id="quarta"> Quarta - feira</button>
        ...
        <td>    <input type='submit'id="ulti3" value="14:30" name="14:30q">   
	...
	<tr><button id="quinta"> Quinta - feira</button>
        ...
        <td>    <input type='submit'id="ulti4" value="14:30" name="14:30w">   
	...
	<tr><button id="sexta"> Sexta - feira</button>
        ...
        <td>    <input type='submit'id="ulti5" value="14:30" name="14:30s">   
...
/////////////////////////////SETIMOS horarios 
          ...
          $("#seti3").ready(function(){
            if(seti3 == 0 || qua == 0){
                document.getElementById("seti3").disabled = true;
